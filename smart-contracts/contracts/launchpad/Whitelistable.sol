...
abstract contract Whitelistable is Ownable, AccessControl, ReentrancyGuard {
    ...
    bytes32 public WHITELIST_SETTER_ROLE =
        keccak256(abi.encodePacked("WHITELIST_SETTER_ROLE"));
    ...
    function setWhitelistSetter(address _whitelistSetter) public onlyOwner {
        require(
            !hasRole(WHITELIST_SETTER_ROLE, _whitelistSetter),
            "already whitelist setter"
        );
